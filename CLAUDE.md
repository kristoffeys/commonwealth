...
relevant issue is moved to Done with a one-line note of what shipped. A PR that changes a
capability's tested behavior updates its row in `docs/08-test-coverage.md` in the same PR.
